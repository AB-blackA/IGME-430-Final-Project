...
const router = (app) => {
  ...
  app.get('/subpage/:subPageName', mid.requiresSecure, mid.requiresLogout, controllers.SubPage.subpagePage);
  app.post('/subpage/:subPageName', mid.requiresSecure, mid.requiresLogout, controllers.SubPage.newThread);
  ...
  app.get('/posts/:subPageName/:threadTitle', mid.requiresSecure, mid.requiresLogout, controllers.Thread.thread);
  app.post('/posts/:subPageName/:threadTitle', mid.requiresSecure, mid.requiresLogout, controllers.Thread.post);
  ...
  app.get('/profile', mid.requiresSecure, mid.requiresLogout, controllers.Profile.profilePage);
  app.post('/profile', mid.requiresSecure, mid.requiresLogout, controllers.Profile.updateBio);
